...
$$
\begin{align*}
AB'+AB'C'D+CD+BC'D+ABCD
&=\sum m(3,5,7,8,9,10,11,13,15)\\
&=AB'(C+C')(D+D')+BD(A+A')(C+C')+A'CD(B+B')\\
&=AB'+BD+AC'D
\end{align*}
$$
...
&=\prod M(0,1,4,5,6,7,10,13)\\
&=\sum m(2,3,8,9,11,12,14,15)\\
&=A'B'C(D+D')+AB'C'(D+D')+ACD(B+B')+ABC(D+D')\\
&=A'B'C+AB'C'+ACD+ABC
\end{align*}
$$
...
F(W,X,Y,Z)
&=\sum m(0,2,4,8,14,15)\\
&=X'Z'(W+W')(Y+Y')+XZ(W+W')(Y+Y')+W'XY'(Z+Z')+WXY(Z+Z')\\
&=X'Z'+XZ+W'XY'+WXY
\end{align*}
$$
